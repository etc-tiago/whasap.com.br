...
export const mvpDefaults = {
  billing: {
    ...
    extraConnectionPriceCents: 4_900,
    ...
    plans: [
      {
        ...
        nome: "Starter",
        priceCents: 24_900,
        contactsIncluded: 2_000,
        connectionsIncluded: 1,
        extraContactsPackPriceCents: 2_000,
      },
      {
        id: "profissional",
        nome: "Profissional",
        priceCents: 44_900,
        contactsIncluded: 5_000,
        connectionsIncluded: 2,
        extraContactsPackPriceCents: 1_800,
      },
      {
        id: "business",
        nome: "Business",
        priceCents: 79_900,
        contactsIncluded: 15_000,
